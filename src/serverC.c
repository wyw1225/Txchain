...
#define C_PORT "23965"  // the port users will be connecting to
...
int main(void)
{
  ...
  int numbytes;
	...
	if ((rv = getaddrinfo(NULL, C_PORT, &hints, &servinfo)) != 0) {
  ...
  if (p == NULL)  {
	...
	printf("The ServerC is up and running using UDP on port 23965.\n");
